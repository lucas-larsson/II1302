...
const insertApplication = async (person_id, availabilities, competences) => {
  const availabilityQuery = `INSERT INTO availability (from_date, to_date, person_id) 
    VALUES ($1, $2, $3) RETURNING from_date, to_date, availability_id`;
  const competenceQuery = `INSERT INTO competence_profile (years_of_experience, competence_id, person_id) 
    VALUES ($1, $2, $3) RETURNING competence_id, years_of_experience, competence_profile_id`;
  try {
